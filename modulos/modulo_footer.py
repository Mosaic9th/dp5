            ...
            [
                ...
                [
                    ...
                    [
                        ...
                        dbc.Row(dmc.Anchor(dbc.Button("Criar Minha Conta", color="link"), href="/criar-conta"), style = {'width':'100%', 'margin-left': '0px', 'padding-left': '10px' }),
                        dbc.Row(dmc.Anchor(dbc.Button("Acessar Minha Conta", color="link"), href="/login"), style = {'width':'100%', 'margin-left': '0px', 'padding-left': '10px' }),
